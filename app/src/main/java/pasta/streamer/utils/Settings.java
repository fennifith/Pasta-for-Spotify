...
public class Settings {
    ...
    final public static String PRELOAD = "preload", LIMIT = "limit", THUMBNAILS = "thumbnails", DARK_THEME = "dark_theme", PALETTE = "palette", PRIMARY = "primary_color", ACCENT = "accent_color", QUALITY = "playback_quality", ORDER = "order";
